...
public record Profile(@JsonSetter(nulls = Nulls.AS_EMPTY) @Nonnull Set<String> anchorCerts,
                      ...
                      @JsonProperty("return_to_service") boolean isReturnToService,
                      @Deprecated(since = "iOS 13", forRemoval = true) @JsonProperty("mandatory") boolean isMandatory,
                      @JsonProperty("mdm_removable") boolean isMdmRemovable,
                      @JsonProperty("multi_user") boolean isMultiUser,
                      @Deprecated(since = "iOS 13", forRemoval = true) @JsonProperty("supervised") boolean isSupervised,
