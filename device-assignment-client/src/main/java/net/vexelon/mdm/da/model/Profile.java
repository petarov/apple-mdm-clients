...
public record Profile(@JsonSetter(nulls = Nulls.AS_EMPTY) @Nonnull Set<String> anchorCerts,
                      ...
                      @JsonProperty("is_return_to_service") boolean isReturnToService,
                      @Deprecated(since = "iOS 13", forRemoval = true) boolean isMandatory, boolean isMdmRemovable,
                      boolean isMultiUser, @Deprecated(since = "iOS 13", forRemoval = true) boolean isSupervised,
