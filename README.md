...
**Releases**:
    ...
    implementation 'net.vexelon.mdm:device-assignment-client:1.0.1-SNAPSHOT'
...
**Releases**:
    ...
    implementation 'net.vexelon.mdm:legacy-app-and-book-management-client:1.0.1-SNAPSHOT'
